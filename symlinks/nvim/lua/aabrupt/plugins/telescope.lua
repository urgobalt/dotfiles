return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>bf", function() builtin.find_files({ cwd = utils.buffer_dir() }) end,
            { desc = 'Find [B]uffers' })
        ...
        vim.keymap.set("n", "<leader>bg", function() builtin.live_grep({ cwd = utils.buffer_dir() }) end,
            { desc = "Live [G]rep" })
