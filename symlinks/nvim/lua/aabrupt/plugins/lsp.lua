    ...
    config = function()
        ...
        local on_attach = function(_, bufnr)
            ...
            vim.keymap.set('n', '<leader>lq',
                function() vim.lsp.buf.code_action({ context = { only = { "quickfix" } } }) end,
                { buffer = bufnr, desc = "LSP Code [Q]uickfix" })
            vim.keymap.set('n', '<leader>lI',
                function() vim.lsp.buf.code_action({ context = { only = { "refactor.inline" } } }) end,
                { buffer = bufnr, desc = "LSP [I]nline Code Action" })
